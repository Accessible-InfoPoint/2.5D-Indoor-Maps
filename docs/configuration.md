...
| `BACKEND_SOURCE`               | enum string              | Data source. Current value is `cachedOverpass`.                                                                        |
| `INDOOR_DATA_PIPELINE`         | enum string              | Indoor rendering pipeline. Current value is `rawIndoorModel`.                                                          |
