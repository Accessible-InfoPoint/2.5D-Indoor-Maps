...
const CONSTANTS_PATH = "../public/strings/constants.json";

module.exports = {URLS, OVERPASS_QUERIES, RESOURCES_TO_DOWNLOAD, MAX_OVERPASS_FILE_AGE_IN_DAYS, COLOR_PROFILE_FOLDER, CONSTANTS_PATH, PATTERN_FILL_IMAGES_FOLDER};
