...
export function hasLevel(feature: GeoJSON.Feature, level: string): boolean {
  ...
  return (
    ((typeof feature.properties.level === 'string' || feature.properties.level instanceof String) && feature.properties.level === level) ||
    (Array.isArray(feature.properties.level) && feature.properties.level.includes(level)) ||
