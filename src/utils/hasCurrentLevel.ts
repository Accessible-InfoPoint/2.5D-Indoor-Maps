...
export function hasLevel(feature: GeoJSON.Feature, level: string): boolean {
  ...
  return (
    ((typeof feature.properties.level === 'string' || feature.properties.level instanceof String) && feature.properties.level === level) || // nodes still have text level, as they should only have one level
